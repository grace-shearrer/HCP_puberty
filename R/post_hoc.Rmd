...
mytable <- xtabs(~node+module, data=IC2_early)
...
mytable <- xtabs(~node+module, data=IC2_late)
mytable
margin.table(mytable, 2)
```
```{r}
...
mytable <- xtabs(~node+module, data=IC3_early)
margin.table(mytable, 2)
```
```{r}
...
mytable <- xtabs(~node+module, data=IC3_3)
margin.table(mytable, 2)
```
```{r}
...
mytable <- xtabs(~node+module, data=IC6_early)
margin.table(mytable, 2)
```
...
mytable <- xtabs(~node+module, data=IC6_late)
margin.table(mytable, 2)
```
```{r}
...
mytable <- xtabs(~node+module, data=IC12_early)
margin.table(mytable, 2)
```
...
mytable <- xtabs(~node+module, data=IC12_late)
margin.table(mytable, 2)
```
...
mytable <- xtabs(~node+module, data=IC13_early)
margin.table(mytable, 2)
```
...
mytable <- xtabs(~node+module, data=IC13_late)
margin.table(mytable, 2)
```
