...
c46<-c(0,0,0,0,1,0,-1)
c56<-c(0,0,0,0,0,1,-1)
contrasts(node_int6$module)<-cbind(c01,c02,c03,c04,c05,c06,c12,c13,c01,c14,c15,c16,c23,c24,c25,c26,c34,c35,c36,c45,c46,c56)
...
cc6.1<-lme(cc~module*early_late, random = ~1|early_late/module, data=node_int6, method="ML")
summary(cc6.1)
interactionMeans(cc6.1,fixed="early_late", across="module")
```
